...
- [ ] **Step 3: Implement the normalized draft contract**
...
- [ ] **Step 1: Write the failing screenshot-transcript regression test**
...
- [ ] **Step 2: Run the loop/parser regression and verify RED**
...
- [ ] **Step 3: Save and clear the per-space draft**
...
- [ ] **Step 2: Review the diff and staged scope**

Confirm unrelated Shopify and web-server changes remain unstaged.

- [ ] **Step 3: Commit only onboarding files**

Run: `git add docs/superpowers/plans/2026-08-15-multi-turn-onboarding.md hackathon/src/agent/mission-parser.ts hackathon/src/agent/prompts.ts hackathon/src/agent/loop.ts hackathon/tests/mission-parser.test.ts hackathon/tests/loop.test.ts`
